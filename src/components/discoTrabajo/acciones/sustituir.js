                ...
                <DialogTitle id="form-dialog-title">
                    <Box display="flex" flexDirection="column">
                        ...
                        <span style={{ fontSize: 16, fontWeight: 200 }}>
                            Registro en contingencia de sustitución del jefe de trabajos <span className={classes.burbuja}>
                                 {props.encargado}</span> en el <span className={classes.burbuja}>Disco {props.numeroDT}</span>
                        </span>
                    </Box>
                </DialogTitle>
                <DialogContent>
